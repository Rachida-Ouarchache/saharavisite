...
const staticUrls = [
  ...
  { loc: '/contact', pri: '0.85', freq: 'monthly' },
  { loc: '/luxury-morocco-tours', pri: '0.8', freq: 'monthly' },
  { loc: '/private-morocco-tours', pri: '0.8', freq: 'monthly' },
  { loc: '/morocco-desert-tours', pri: '0.8', freq: 'monthly' },
  { loc: '/sahara-desert-tours', pri: '0.8', freq: 'monthly' },
  { loc: '/marrakech-tours', pri: '0.8', freq: 'monthly' },
  { loc: '/marrakech-sahara-tour', pri: '0.85', freq: 'monthly' },
